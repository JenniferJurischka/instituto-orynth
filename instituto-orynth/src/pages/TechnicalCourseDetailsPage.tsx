...
export default function TechnicalCourseDetailsPage() {
  const { id } = useParams()
  const course = id ? technicalCoursesCatalog[id] : null

  if (!course) {
    return (
      <main className="min-h-screen bg-neutral-950 px-6 py-16 text-white">
        <div className="mx-auto max-w-5xl">
          <p className="text-white/70">Curso técnico não encontrado.</p>
